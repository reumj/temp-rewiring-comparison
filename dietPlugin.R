#' This script introduces the function DietComp that calculates the diet of a MizerSim object and plotDietComp to analyse the result

library(ggplot2) # for the plot

#' MizerSim input, output a 4D arrays of diet at the last time step of the simulations (useful only if ecosystem dynamics are at equilibrium)
#' The array is predator/predator size/prey/prey size
#' The ouput can be used in conjonction with plotDietComp to visualise the diet
...
#' I haven't tested the user-friendlyness of this function so one might need to adjust some hardcoded parameters value (especiially for the ggplot)
