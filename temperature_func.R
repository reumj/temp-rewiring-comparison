...
#' 
#' uses the latest version of Mizer (10/2020) and changes 4 parameters that are temperature sensitive
...
#' This function uses a Mizer param object as input and will return the same object with rates adjusted to the temperature influence.
#' Use the scalar = T option to return the values of the temperature scalar instead of a Mizer param object (default is F).
#' 
#' 
